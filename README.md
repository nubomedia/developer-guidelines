...
This repository contains a [MkDocs] project with the Development Guidelines for
[NUBOMEDIA].
...
MkDocs supports Python 2.6, 2.7, 3.3, 3.4 and 3.5. Install the mkdocs package
using `pip`:
...
To generate the site folder with the HTML files (on http://localhost:8000/ by
default):
